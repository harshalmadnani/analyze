...
const kadenafunctions = {
  graphqlEndpoint: process.env.KADENA_GRAPHQL_ENDPOINT || process.env.REACT_APP_KADENA_GRAPHQL_ENDPOINT || 'https://api.mainnet.kadindexer.io/v0',
  graphqlApiKey: process.env.KADENA_GRAPHQL_KEY || process.env.REACT_APP_KADENA_GRAPHQL_KEY,
  
  // Configure request throttling and retry settings
  requestThrottleMs: parseInt(process.env.REQUEST_THROTTLE_MS || process.env.REACT_APP_REQUEST_THROTTLE_MS || '1000'), // Default: 1 second between requests
  maxRetries: parseInt(process.env.MAX_RETRIES || process.env.REACT_APP_MAX_RETRIES || '3'),  // Default: Maximum of 3 retries
